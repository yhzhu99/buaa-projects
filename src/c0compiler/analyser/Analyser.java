...
import c0compiler.ast.WhileTree;
import c0compiler.ast.BooleanTree;
import c0compiler.ast.ConditionTree;
import c0compiler.ast.OperatorTree;
import c0compiler.error.*;
import c0compiler.instruction.Instruction;
import c0compiler.instruction.Operation;
...
//
    ...
    private List<Instruction> analyseCallParamList(List<TokenType> tokenTypes) throws CompileError {
      ...
      //  instructions.addAll(com.c0.ast.OperatorTree.addAllReset());
        int i;
